...
urlpatterns = [
    ...
    path('account/email/', views.update_email_view),
    path('account/password/', views.change_password_view),
    path('account/forename/', views.update_forename_view),
    path('account/surname/', views.update_surname_view),
    path('account/address/', views.update_address_view),
    ...
    path('manager/performers/', views.linked_performers_view),
